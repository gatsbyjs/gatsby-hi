...
> 💡 जैसा की आपने [भाग १](/tutorial/part-one/) मे सीखा, यह आपके साइट का प्रोडक्शन बिल्ड करता है और `public` डायरेक्टरी के अंदर बिल्ड स्टैटिक फाइल्स को आउटपुट करताा है।
