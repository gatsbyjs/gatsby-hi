...
1. एक नया फोल्डर `Src/Components` बनाएँ और फिर, इस नये फोल्डर में, 'container.js` नाम की फ़ाइल बनाएँ और निम्नलिखित को चिपकाएँ:
...
अब जारी रखें [ट्यूटोरियल के भाग तीन] (/tutorial/part-three/), जहां आप Gatsby plugins और लेआउट कौम्पोनॅन्ट के बारे में जानेंगे।