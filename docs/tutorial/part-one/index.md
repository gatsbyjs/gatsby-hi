...
> 💡 JSX में, आप किसी भी Javascript एक्सप्रेशन को `{}` के साथ रैप करके एम्बेड कर सकते हैं। इस प्रकार आप “प्रॉप्स” ऑब्जेक्ट से `headerText` प्रॉपर्टी (या “प्रोप!”) को एक्सेस कर सकते हैं।
