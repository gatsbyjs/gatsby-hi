...
लेआउट कौम्पोनॅन्टस उस साइट के अनुभागों के लिए हैं जिन्हें आप कई पेजेज में शेयर करना चाहते हैं। उदाहरण के लिए, Gatsby साइटों में आमतौर पर एक साझा हेडर और फुटर के साथ एक लेआउट कौम्पोनॅन्ट होगा। लेआउट में ऐड करने के लिए अन्य सामान्य चीजों में एक साइडबार और/या एक नेविगेशन मेनू शामिल है।
...
फ़ाइल को सेव करने के बाद, आपको contact पेज दिखना चाहिए और आप होमपेज लिंक से होमपेज पर जा सकते है।
...
अब, [**अपनी साइट में स्टाइल्स को शामिल करने**](/tutorial/part-two/) टुटोरिअल पर चलें !