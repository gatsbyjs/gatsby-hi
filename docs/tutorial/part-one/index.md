...
[**पिछले भाग**](/tutorial/part-zero/) में, आपने आवश्यक सॉफ़्टवेयर इनस्टॉल करके लोकल डेवेलपमेंट एन्वाइरन्मेंट तैयार किया और [**“hello world” स्टार्टर**](https://github.com/gatsbyjs/gatsby-starter-hello-world) का उपयोग करके अपना पहला Gatsby साइट बनाया। अब, उस स्टार्टर द्वारा उत्पन्न कोड के बारे में हम और गहराई से जानेंगे।
...
एक नया Gatsby साइट बनाते समय, आप एक नई साइट बनाने के लिए किसी भी मौजूदा Gatsby स्टार्टर के आधार पर निम्न कमांड का उपयोग कर सकते हैं:
...
_नोट: फिर से, यहां दिखाया गया एडिटर Visual Studio Code है। यदि आप एक अलग एडिटर का उपयोग कर रहे हैं, तो यह थोड़ा अलग दिखेगा_

आइए होमपेज के कोड पर एक नज़र डालें।

> 💡 यदि आपने पिछले खंड में `gatsby develop` को रन करने के बाद अपने डेवेलपमेंट सर्वर को स्टॉप कर दिया है, तो इसे अब फिर से स्टार्ट करें — अब हैलो-वर्ल्ड साइट में कुछ बदलाव करने का समय है!

## Gatsby पेजो के साथ परिचय

अपने कोड एडिटर में `/src` फोल्डर खोलें। उसमे एक सिंगल फोल्डर `/pages` मिलेगा।

अब `src/pages/index.js` फ़ाइल को खोलें। इस फ़ाइल में कोड एक कौम्पोनॅन्ट बनाता है जिसमें एक ही div और कुछ text होता है - उचित रूप से, "Hello World!"

### ✋ “Hello World” होमपेज मे परिवर्तन करे

1. "Hello World!" text को "Hello Gatsby!" में बदलें और फाइल को सेव करें। यदि आपके विंडोस अगल-बगल हैं, तो आप देख सकते हैं कि फ़ाइल को सेव करने के बाद आपके कोड और कॉंटेंट्स मे परिवर्तन लगभग तुरंत ही ब्राउज़र में दिखाई देते हैं।
...
>💡 Gatsby आपके डेवेलपमेंट प्रोसेस को तेज करने के लिए **hot reloading** का उपयोग करता है। अनिवार्य रूप से, जब आप एक Gatsby डेवेलपमेंट सर्वर चला रहे हैं, तो Gatsby साइट फ़ाइलों को बॅकग्राउंड मे "देखा" जा सकता है - जब भी आप किसी फ़ाइल को सेव करते हैं, तो आपके परिवर्तन तुरंत ब्राउज़र में दिखाई देंगे। आपको पेज को हार्ड रिफ्रेश करने या डेवेलपमेंट सर्वर को पुनः स्टार्ट करने की आवश्यकता नहीं है - आपके परिवर्तन तुरंत दिखाई देते हैं।

2. अब आप अपने बदलावों को थोड़ा और स्पष्ट कर सकते हैं। नीचे दिए गए कोड को `src/pages/index.js` में बदलने का प्रयास करें और फिर से सेव करें। आप text में परिवर्तन देखेंगे - text का कलर बैंगनी होगा और फ़ॉन्ट का आकार बड़ा होगा।
...
3. फ़ॉन्ट साइज़ स्टाइल को हटा दे, "Hello Gatsby!" text को एक लेवेल वन हेडर में बदलें, और हेडर के नीचे एक पैराग्राफ डाले।
...
लेआउट कौम्पोनॅन्टस उस साइट के अनुभागों के लिए हैं जिन्हें आप कई पेजो में साझा करना चाहते हैं। उदाहरण के लिए, Gatsby साइटों में आमतौर पर एक साझा हेडर और फुटर लेख के साथ एक लेआउट कौम्पोनॅन्ट होगा। लेआउट में जोड़ने के लिए अन्य सामान्य चीजों में एक साइडबार और / या एक नेविगेशन मेनू शामिल है।

आप लेआउट कौम्पोनॅन्टस के बारे में [**भाग तीन**](/tutorial/part-three/) मे जानेंगे।

## पेजो के बीच लिंकिंग

आप अक्सर पेजो के बीच लिंक करना चाहते हैं - चलिए Gatsby साइट में राउटिंग देखते है।
...
Gatsby `<Link />` कौम्पोनॅन्ट आपकी साइट के पेजो के बीच लिंक करने के लिए है। आपकी Gatsby साइट द्वारा नियंत्रित नहीं किए गए पेजो के बाहरी लिंक के लिए, नियमित HTML `<a>` टैग का उपयोग करें।
...
अपनी पहली Gatsby वेबसाइट को डिप्लाय करने के लिए [सर्ज](http://surge.sh/) का उपयोग करने का प्रयास करें। सर्ज कई "स्टैटिक साइट होस्ट" में से एक है जो Gatsby साइटों को डिप्लाय करना संभव बनाता है।
