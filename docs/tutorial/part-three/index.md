...
Gatsby प्लगइन्स जावास्क्रिप्ट पैकेज हैं जो एक Gatsby साइट में फ़ंक्शनैलिटी डालने में मदद करते हैं। Gatsby को एक्स्टेंसिबल रहने के लिए डिज़ाइन किया गया है, जिसका अर्थ है प्लगिन्स सब कुछ जो Gatsby करता है उसको एक्सटेंड और मॉडिफाई कर सकता है।

लेआउट कौम्पोनॅन्टस आपकी साइट के उन हिस्सों के लिए हैं जिन्हें आप कई पेजेज़ में शेयर करना चाहते हैं। उदाहरण के लिए, साइटों में आमतौर पर एक शेयर्ड हेडर और फुटर के साथ एक लेआउट कौम्पोनॅन्टस होगा। लेआउट में जोड़ने के लिए अन्य सामान्य चीजें एक साइडबार और / या नेविगेशन मेनू हैं। उदाहरण के लिए इस पेज पर, सबसे ऊपर का हेडर gatsbyjs.org के लेआउट कौम्पोनॅन्टस का हिस्सा है।

चलिए भाग तीन शुरू करते हैं।

## प्लगइन्स का उपयोग करना

आप शायद प्लगइन्स के विचार से परिचित हैं। कई सॉफ्टवेयर सिस्टम नई कार्यक्षमता जोड़ने या सॉफ़्टवेयर के मुख्य कामकाज को संशोधित करने के लिए कस्टम प्लगइन्स को जोड़ने का समर्थन करते हैं। Gatsby प्लगइन्स उसी तरह काम करते हैं।
