...
लेकिन `/about/`, या `/contact/` के लिए नेविगेट करने का प्रयास करें। उन पृष्ठों का कंटेंट अभी भी केंद्रित नहीं होगी।

4. लेआउट कौम्पोनॅन्टस को `about.js` और `contact.js` में import करें (जैसा कि आपने पिछले चरण में `index.js` के लिए किया था)।

एक अकेले शेयर्ड लेआउट कौम्पोनॅन्ट से सरे तीनो पेजेज के कंटेंट सेण्टर में हो गए हैं!
