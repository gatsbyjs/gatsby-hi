---
शीर्षक: नेस्टेड लेआउट कम्पोनेंट्स बनाना
...
इस भाग में, आप गैट्सबी प्लगइन्स और "लेआउट" घटक बनाने के बारे में जानेंगे।

Gatsby plugins जावास्क्रिप्ट पैकेज हैं जो एक Gatsby साइट में कार्यक्षमता जोड़ने में मदद करते हैं। Gatsby को एक्स्टेंसिबल के लिए डिज़ाइन किया गया है, जिसका अर्थ है कि प्लगइन्स Gatsby जो भी करता है उसके बारे में सिर्फ विस्तार और संशोधन करने में सक्षम है।

लेआउट घटक आपकी साइट के उन हिस्सों के लिए हैं जिन्हें आप कई पृष्ठों में साझा करना चाहते हैं। उदाहरण के लिए, साइटों में आमतौर पर एक साझा हेडर और पाद लेख के साथ एक लेआउट घटक होगा। लेआउट में जोड़ने के लिए अन्य सामान्य चीजें एक साइडबार और / या नेविगेशन मेनू हैं। उदाहरण के लिए इस पृष्ठ पर, शीर्ष पर शीर्ष लेख gatsbyjs.org के लेआउट घटक का हिस्सा है।

चलो भाग तीन  शुरू करते हैं।

## प्लगइन्स का उपयोग करना

आप शायद प्लगइन्स के विचार से परिचित हैं। कई सॉफ्टवेयर सिस्टम नई कार्यक्षमता जोड़ने या सॉफ़्टवेयर के मुख्य कामकाज को संशोधित करने के लिए कस्टम प्लगइन्स को जोड़ने का समर्थन करते हैं। Gatsby plugins उसी तरह काम करते हैं।

समुदाय के सदस्य (आप की तरह!) प्लगइन्स (जावास्क्रिप्ट कोड की छोटी मात्रा) का योगदान कर सकते हैं जो अन्य लोग तब उपयोग कर सकते हैं जब Gatsby साइटों का निर्माण करते हैं।

> पहले से ही सैकड़ों प्लगइन्स हैं! गैट्सबी [प्लगइन लाइब्रेरी] (/pluginw/) का अन्वेषण करें।

प्लगइन्स के साथ हमारा लक्ष्य उन्हें स्थापित करने और उपयोग करने के लिए सीधा करना है। आप संभवतः आपके द्वारा बनाए गए लगभग हर गैट्सबी साइट में प्लगइन्स का उपयोग कर रहे होंगे। बाकी ट्यूटोरियल के माध्यम से काम करते समय आपके पास प्लगइन्स को स्थापित करने और उपयोग करने के कई अवसर हैं।

प्लगइन्स का उपयोग करने के लिए प्रारंभिक परिचय के लिए, हम टाइपोग्राफी के लिए Gatsby प्लगइन को स्थापित और कार्यान्वित करेंगे।

[टाइपोग्राफी.जेएस] (https://kyleamathews.github.io/typography.js/) एक जावास्क्रिप्ट लाइब्रेरी है जो आपकी साइट की टाइपोग्राफी के लिए वैश्विक आधार शैली उत्पन्न करती है। लाइब्रेरी में एक Gatsby साइट का उपयोग करके इसे स्ट्रीमलाइन करने के लिए [संबंधित गैट्सबी प्लगइन] (/ संकुल / gatsby- प्लगइन-टाइपोग्राफी /) है।
...
![with-layout2](with-layout2.png)
 ...
 आपने अपना पहला Gatsby प्लगइन स्थापित और कॉन्फ़िगर किया है!
...
आप अपना पहला लेआउट घटक बनाकर इन परिवर्तनों से निपटेंगे।

### ✋ अपना पहला लेआउट घटक बनाएँ

1. `src / Components` पर एक नई निर्देशिका बनाएँ।

2. `src / Components / layout.js` पर एक बहुत ही बुनियादी लेआउट घटक बनाएँ:
...
3. इस नए लेआउट घटक को अपने `src/pages/index.js` पेज घटक में आयात करें:
...
4. लेआउट घटक को `about.js` और` contact.js` में आयात करें (जैसा कि आपने पिछले चरण में `index.js` के लिए किया था)।

आपके सभी तीन पृष्ठों की सामग्री इस एकल साझा लेआउट घटक के लिए धन्यवाद केंद्रित है!

### ✋ साइट शीर्षक जोड़ें

1. अपने नए लेआउट घटक में निम्न पंक्ति जोड़ें:
...
1. अपने लेआउट घटक फ़ाइल में निम्नलिखित की प्रतिलिपि बनाएँ:
...
_चुनौती:_ अपनी नई "लेआउट घटक" शक्तियों के साथ, अपने Gatsby साइटों पर हेडर, फुटर, ग्लोबल नेविगेशन, साइडबार आदि जोड़ने की कोशिश कर रहा है!
