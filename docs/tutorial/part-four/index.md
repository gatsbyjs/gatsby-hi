...
[StaticQuery](/docs/static-query/) Gatsby v2 में शुरू किया गया एक नया API है जो नॉन-पेज कौम्पोनॅन्टस (जैसे आपके `layout.js` कौम्पोनॅन्ट) को GraphQL queries के माध्यम से डेटा को पुनः प्राप्त करने की अनुमति देता है। 
आइए इसमें शुरू किए गए नए [`useStaticQuery`](/docs/use-static-query/) hook version का उपयोग करें।
