...
1. [प्लगइन लाइब्रेरी](/plugins/) देखें ताकि आप यह जान पाए की जिस स्रोत प्लगइन्स और/या ट्रांसफॉर्मर प्लगइन्स का आप उपयोग करना चाहते हैं वो पहले से ही मौजूद हैं या नहीं|
...
GraphQL का आविष्कार फेसबुक द्वारा प्रोडक्ट इंजीनियरों को कॉम्पोनेंट्स के अंदर डाटा _pull_ करने मे मदद करने के लिए किया गया था| 
...
ट्यूटोरियल के इस भाग के लिए एक और नई साइट बनाएँ। आप एक Markdown ब्लॉग बनाने जा रहे हैं जिसका नाम है "Pandas Eating Lots"। यह बहुत सारे भोजन खाने वाले पांडा के सर्वोत्तम चित्रों और वीडियो को दिखाने के लिए समर्पित है। रास्ते में, आप GraphQL और Gatsby के मार्कडाउन सपोर्ट भी सीखेंगे।
...
[StaticQuery](/docs/static-query/) Gatsby v2 में शुरू किया गया एक नया API है जो गैर-पेज कौम्पोनॅन्टस (जैसे आपके `layout.js` कौम्पोनॅन्ट) को GraphQL queries के माध्यम से डेटा को पुनः प्राप्त करने की अनुमति देता है। आइए इसमें शुरू किए गए नए [`useStaticQuery`](/docs/use-static-query/) hook version का उपयोग करें।

चलिए `src/components/layout.js` फ़ाइल में  `useStaticQuery` hook का उपयोग करते हुए कुछ परिवर्तन करें और `{data.site.siteMetadata.title}` का reference करे। जब यह पूरा हो जायेगा, तो आपकी फ़ाइल इस तरह दिखाई देगी:
