...
आप एक ही नेटवर्क पर अन्य उपकरणों पर अपने dev एन्वाइरन्मेंट की जानकारीे के लिए होस्ट ओप्शंस के साथ Gatsby develop कमांड का उपयोग कर सकते हैं, निचे दी गयी कमांड चलाएं:
...
**ध्यान दें**: आप Windows पर 0.0.0.0:8000 पर नहीं जा सकते हैं (लेकिन विंडोज पर localhost:8000 या "आपके नेटवर्क की" URL से सब कुछ चलेगा)
