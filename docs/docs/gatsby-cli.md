...
| `--no-color`, `--no-colors`  | कलर टर्मिनल आउटपुट डिसेबल्ड करता है                                                                       |
...
एक Gatsby साइट की रूट में, टेस्ट करने के लिए अपनी प्रोडक्षन बिल्ड साइट सर्व करें:
...
यह अंतिम उपाय के रूप में उपयोगी है जब आपके लोकल प्रोजेक्ट में इश्यू हो या कॉंटेंट रेफ्रेश नहीं होती है। यह आमतौर पर ठीक हो सकता है:

- स्टेट डेटा, उदाहरण के लिए यह file/resource/etc दिखाई नहीं देता है।
- GraphQL एरर, उदाहरण के लिए यह GraphQL रीसोर्स मौजूद होना चाहिए लेकिन ऐसा नहीं है।
- डिपेंडेन्सी इश्यूस उदाहरण के लिए अमान्य संस्करण, कंसोल में गुप्त एरर आदि।
- प्लगिन मुद्दे, उदाहरण के लिए एक लोकल प्लगइन विकसित करना और परिवर्तन प्रभावी होना प्रतीत नहीं होता है।
...
plugin का उपयोग करने और बनाने के बारे में आपको दस्तावेज़ों को निर्देशित करता है।
...
[GraphQL explorer](/docs/introducing-graphiql/) के साथ उपयोग करने पर, ये आरईपीएल कमांड आपके Gatsby साइट के डेटा को समझने के लिए बहुत सहायक हो सकते हैं।

अधिक जानकारी के लिए, देखें [Gatsby REPL डॉक्युमेंटेशन](/docs/gatsby-repl/)

### कलर आउटपुट को डिसेबल करना

सीएलआई ओप्शंस `--no-color` के अलावा एन्वाइरन्मेंट वेरियबल `NO_COLOR` की उपस्थिति का सम्मान करता है (देखें [no-color.org](https://no-color.org/)).
...
एक बार जब आप अपनी पसंद बना लेते हैं, तो सीएलआई किसी भी बाद की प्रोजेक्ट के लिए आपकी प्राथमिकता के लिए नहीं पूछेगा।

यदि आप इसे अपनी अगली प्रोजेक्ट के लिए बदलना चाहते हैं, तो आपको सीएलआई द्वारा स्वचालित रूप से बनाई गई कॉन्फ़िगर फ़ाइल को  एडिट करना होगा।
