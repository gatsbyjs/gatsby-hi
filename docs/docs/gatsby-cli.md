...
अपनी साइट को टेस्ट करने के लिए, प्रोडक्शन बिल्ड को एक Gatsby साइट के रुट में सर्वर करें::
...
- स्टेट डेटा, उदाहरण के लिए यह file/resource/etc दिखाई नहीं दे रहा है।
