...
इशू लेबल GitHub में एक उपकरण है जो एक या अधिक कैटगोरी में ग्रुप के इशू के लिए उपयोग किया जाता है।
...
- सुविधा का अनुरोध(रिक्वेस्ट)
- डुप्लिकेट इशू
- ऐसे इशू जो रुके हुए या अवरुद्ध(ब्लॉक्ड) हैं

## इशू को कौन लेबल कर सकता है?

[`Gatsby मेंटेनर्स टीम`](https://github.com/orgs/gatsbyjs/teams/maintainers) का कोई भी सदस्य(मेंबर) हो वह इशू को लेबल कर सकता हैं।

पुल रिक्वेस्ट को Gatsby प्रोजेक्ट में मर्ज कर आप टीम को इन्वाइट कर सकते हैं। लिस्ट चेक करे
